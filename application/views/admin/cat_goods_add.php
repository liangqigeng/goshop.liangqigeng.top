    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        <form method="post" action="">
            <div>
            <label>分类名称</label>
            <input type="text" value="" class="input-xxlarge" name="cat_name">
            <label>所属父级ID</label>
            <input type="text" value="" class="input-xxlarge" name="parent_id">
            <label>分类排序</label>
            <input type="text" value="" class="input-xxlarge" name="cat_ord">
            </div>
