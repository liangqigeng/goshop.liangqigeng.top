    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        <form method="post" action="">
            <div>
            <label>导航名称</label>
            <input type="text" value="" class="input-xxlarge" name="nav_name">
             <label>导航url</label>
            <input type="text" value="" class="input-xxlarge" name="nav_url">
            <label>导航排序</label>
            <input type="text" value="" class="input-xxlarge" name="nav_ord">s
            </div>
