<div class="content">
        <div class="header">
            <h1 class="comment-title">添加评论</h1>
        </div>
                <ul class="breadcrumb">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        <form method="post" action="">
            <div>
            <label>用户ID</label>
            <input type="text" value="" class="input-xxlarge" name="user_id">
             <label>商品ID</label>
            <input type="text" value="" class="input-xxlarge" name="goo_id">
             <label>评论内容</label>
            <input type="text" value="" class="input-xxlarge" name="com_content">
            <label>评论邮箱</label>
            <input type="text" value="" class="input-xxlarge" name="com_email">
            </div>
