...
<div class="btn-toolbar">
    <button class="btn btn-primary" onClick="location='<?php echo site_url('admin/admin/admin_add');?>'"><i class="icon-plus"></i>添加管理员</button>
  <div class="btn-group">
  </div>
</div>
<div id="show"></div>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
              <a href="<?php echo site_url('admin/admin/admin_edit/'.$v['admin_id']);?>"><i class="icon-pencil"></i></a>
              <a href="#myModal" role="button" data-toggle="modal" class="delete" ddd="<?php echo $v['admin_id'];?>"><i class="icon-remove"></i></a>
          </td>
        </tr>
      <?php }?>
      </tbody>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script type="text/javascript">
        ...
        $('#del').click(function () {
            ...
            $.ajax({
                type : 'get',
                url : "<?php echo site_url('admin/admin/admin_del');?>",
                data : "id="+id,
                dataType : 'text',
                success : function (z) {
                    console.log(z);
